...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-offset-5 col-md-3">
            ...
            <input type="text" name="username" class="form-control input-sm chat-input" placeholder="Email Address" />
            ...
            <div class="wrapper">
               ...
               <input class="btn btn-primary"  type="submit" name="login" value="Login">            </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-offset-5 col-md-3">
            ...
            <div class="wrapper">
               ...
               <input align="left" class="btn btn-primary"  type="submit" name="login" value="Login">
               <input align="right" class="btn btn-primary"  type="submit" name="signin" value="SignIn">
               </div>
            </div>
...
<form method="post" action="login_cart.php?pno=<?php echo $id?>" enctype="multipart/form-data">  
<div class="container">
