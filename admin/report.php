...
$i=1;
	...
	$result5 = mysqli_query($con,"select distinct(pname), sum(order_quantity) as sum from product,order_item where product.pno = order_item.pno GROUP BY pname Having sum >0 ");
