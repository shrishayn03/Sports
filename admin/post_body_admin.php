...
<table width="700px" align="center" border="2" style=" margin-top:1em;">
	<tr>
		<td height="20px"  colspan="7" align="center" bgcolor="#3366FF"><h3><font color="#00FF99">View Admin Posts</font></h3></td>
	</tr>
...
?>
    ...
    <tr align="center">
        ...
        <td><a href="admin_edit.php?edit=<?php echo $post_id?>">Edit</a></td>
