...
?>
<body><div><?php include("user_sidebar.php");?></div>


<form method="post" action="insert_post_user.php" enctype="multipart/form-data">
...
$user_id = $_SESSION['user_id'];
 ...
 if(isset($_POST['submit'])){
    ...
    $query = "insert into post(post_title,post_date,post_author,post_image,post_content,post_view,user_id) values('$title','$date','$author','$image_nm','$content',0,$user_id)";
